...
- [ ] **The giants still cannot go full depth in one download.** France
      ...
      and a full-country plan holds roughly 300–400 MB transiently.
- [ ] **Region boxes are boxes.** The country picker (Natural Earth data,
      committed catalogue, regenerated by tools/gen-regions.py) uses
      bounding boxes, so a country download includes slivers of its
      neighbours, and countries crossing the antimeridian — Russia, Fiji,
