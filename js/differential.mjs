...
/* The corpus header names its mnemonic, so a sweep can vary the key -- which
   drags the KDF and the round schedule into the differential. The fixed
   default matches the generator's. */
let mnemonic =
