/* Site-wide notices, across the top of the screen.
   ...
   For conditions that affect the whole application rather than one action, a
   missing basemap being the example. The result of a button the user just
   pressed is a toast instead; the difference is whether it will still be
   true in a minute.

   `role="status"` rather than `alert`: these are degradations to work
   around, and an alert would cut across whatever the user was doing. */
